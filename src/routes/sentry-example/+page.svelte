...
<div>
  <main>
    ...
    <p class="description">
      Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://open-brewery-db.sentry.io/issues/?project=4509183525322752">Issues Page</a>. 
