...
<div>
  <div class="sm:hidden sticky top-0 bg-amber-50 py-3 px-2 border-b border-amber-200 shadow-sm">
    <div class="relative">
      <label for="tabs" class="block text-amber-700 font-medium mb-1 text-sm">Jump to section</label>
      <select
        id="tabs"
        name="tabs"
      ...
      <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 mt-6">
